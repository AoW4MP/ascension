...
async function GetAllData() {
    ...
    const jsonFilePaths = ['/ascension/Data/HeroItems.json', '/ascension/Data/HeroSkills.json', '/ascension/Data/SiegeProjects.json', '/ascension/Data/Units.json', '/ascension/Data/Traits.json',
        '/ascension/Data/Tomes.json', '/ascension/Data/Abilities.json', '/ascension/Data/EmpireProgression.json', '/ascension/Data/Spells.json', '/ascension/Data/StructureUpgrades.json',
        '/ascension/Data/CombatEnchantments.json', '/ascension/Data/WorldStructures.json', '/ascension/Data/EnchantmentTables.json', '/ascension/Data/SpawnTables.json',
        '/ascension/Data/FactionCreation.json', '/ascension/Data/HeroTraits.json', '/ascension/Data/BuilderLookup.json', '/ascension/Data/AscendedInfo.json'
    ];
...
function ShowUnitFromLink() {
    ...
    document.title = "Age of Wonders 4 Ascension - " + GetUnitTierAndName(unitID).split(">")[2];
...
function SetButtonsAndDivs(list, parent, cardType) {
    ...
    for (i in list) {
        ...
        if (cardType === "tome") {
            ...
            btn.innerHTML = "<img style=\"float:left;\" src=\"/ascension/Icons/TomeIcons/" + splitIcon[1] + ".png\" width='25px'\">" + GetUnitTierAndName(splitIcon[0]);
...
function addUnitTypeIcon(a, holder, origin) {
    ...
    for (j in jsonUnitAbilities) {
        if (a === jsonUnitAbilities[j].slug) {
            ...
            imag.setAttribute("src", "/ascension/Icons/Abilities/" + iconsrc + ".png");
            imag.setAttribute('onerror', "this.setAttribute('src','/ascension/Icons/Text/mp.png')");
            imag.setAttribute("width", "40");
            imag.setAttribute("height", "40");


            spa.innerHTML = "<img style=\"float:left; height:30px; width:30px\" src=\"/ascension/Icons/Abilities/" + iconsrc + ".png\"><p style=\"color: #d7c297;>" + "<span style=\"font-size=20px;\">" + iconName + "</p>" +
                "</br>" + icontext;
            iconName = jsonUnitAbilities[j].name;
            if (iconName === "Shock Unit" || iconName === "Shield Unit" ||
                ...
                unitType = iconsrc;
                unitRole.setAttribute("src", "/ascension/Icons/Text/" + iconsrc + ".png");
            }
                                ...
                                if ('type2' in jsonEnchantments[k].attack[t]) {
                                    if (jsonEnchantments[k].attack[t].type2.indexOf("*") != -1) {
                                        if (combinedReq.indexOf(jsonEnchantments[k].attack[t].type) != -1 || combinedReq.indexOf(jsonEnchantments[k].attack[t].type2.split("*")[1]) != -1) {
                                            ...
                                            abilityEncht += "<bullet><img src=\"/ascension/Icons/SpellIcons/" + jsonEnchantments[k].id + ".png\" height='20px'>" + jsonEnchantments[k].attack[t].description + "<br>";
...
abilityDam = combineDamageStrings(abilityDam, jsonEnchantments[k].damage_change);
            ...
            var abilityIconType = "";
            imag.setAttribute("src", "/ascension/Icons/Abilities/" + abilityIcon + ".png");

            var abilityIconType = GetAbilityBackground(abilityDam);

            imag.setAttribute("style", "background-image: url(\"/ascension/Icons/Interface/" + abilityIconType + ".png\");background-repeat: no-repeat;background-size: 40px 40px");
            ...
            if (Cooldown != "") {
                ...
                imageExtra.setAttribute("src", "/ascension/Icons/Text/turn.png");
            ...
            if (Once != "") {
                var imageExtra = document.createElement("IMG");
                imageExtra.setAttribute("src", "/ascension/Icons/Text/once.png");
                imageExtra.setAttribute("style", " position: absolute; height: 18px; left: 0px;bottom: 4px;");
                btn.append(imageExtra);
            }
...
function GetAbilityToolTip(ability, abilityDam, abilityName, abilityIconType, abilityAcc, abilityRange, abilityMod, abilityEncht, abilityNote, abilityReq, cooldown, once) {
    ...
    abilityHighlighter.innerHTML = "<img style=\"float:left; height:50px; width:50px; background-image:url(\'/ascension/Icons/Interface/" + abilityIconType + ".png');background-repeat: no-repeat;background-size: 50px\" src=\"/ascension/Icons/Abilities/" + ability.icon + ".png\">";
...
function addUniquePassiveSlot(enchantment, descr, div, overwrite) {
    ...
    imag.setAttribute("src", "/ascension/Icons/SpellIcons/" + abilityIcon + ".png");
    imag.setAttribute('onerror', "this.setAttribute('src','/ascension/Icons/Text/mp.png')");
    imag.setAttribute("width", "40");
    imag.setAttribute("height", "40");
...
function CreateUniquePassiveSlotToolTip(abilityIcon, abilityName, abilityDescr) {
    ...
    spa.innerHTML = "<img style=\"float:left; height:30px; width:30px\" src=\"/ascension/Icons/SpellIcons/" + abilityIcon + ".png\"><p style=\"color: #d7c297;>" + "<span style=\"font-size=20px;\">" + abilityName.toUpperCase() + "</p>" +
        "<hr>" + abilityDescr;
...
function CreatePassiveSlotToolTip(abilityIcon, abilityName, abilityDescr) {
    ...
    spa.innerHTML = "<div class=\"abilityHighLighter\"><img style=\"float:left; height:30px; width:30px\" src=\"/ascension/Icons/Abilities/" + abilityIcon + ".png\"><p style=\"color: #d7c297;>" + "<span style=\"font-size=20px;\">" + abilityName.toUpperCase() + "</p>" +
        "</div>" + "<hr>" + abilityDescr;
    ...
    for (j in jsonUnitAbilities) {
        if (a === jsonUnitAbilities[j].slug) {
            ...
            if (a.indexOf("frost") !== -1) {
                imag.setAttribute("src", "/ascension/Icons/Text/frost_resistance.png");
                spa.innerHTML += "<defensefrost></defensefrost>";
            }
            if (a.indexOf("blight") !== -1) {
                imag.setAttribute("src", "/ascension/Icons/Text/blight_resistance.png");
                spa.innerHTML += "<defenseblight></defenseblight>";
            }
            if (a.indexOf("fire") !== -1) {
                imag.setAttribute("src", "/ascension/Icons/Text/fire_resistance.png");
                spa.innerHTML += "<defensefire></defensefire>";
            }
            if (a.indexOf("spirit") !== -1) {
                imag.setAttribute("src", "/ascension/Icons/Text/spirit_resistance.png");
                spa.innerHTML += "<defensespirit></defensespirit>";
            }
            if (a.indexOf("lightning") !== -1) {
                imag.setAttribute("src", "/ascension/Icons/Text/lightning_resistance.png");
...
function addstatusResistanceSlot(a, holder) {
    ...
    imag.setAttribute("src", "/ascension/Icons/Text/status_resistance.png");
    ...
    for (i in jsonUnits) {
        ...
        if(keepgoing){
            ...
            if (unitCard == undefined) {
                ...
                imagelink.setAttribute('src', "/ascension/Previews/" + jsonUnits[i].id + ".mp4");
                if (imagelink.getAttribute('src') === "/ascension/Previews/undefined") {
                    imagelink.setAttribute('src', "/ascension/Previews/placeholder.mp4");
                }
            ...
            if (MountedSpecialList.includes(a) || CheckIfOptionalCavalry(a)) {
                ...
                imag = document.createElement("IMG");
                imag.setAttribute("src", "/ascension/Icons/Text/MountInteraction.png");
            ...
            if (CheckIfFormUnit(a)) {
                ...
                imag.setAttribute("src", "/ascension/Icons/FactionCreation/human.png");

                imag.setAttribute("width", "40");
                imag.setAttribute("height", "40");


                span.innerHTML = "<img style=\"float:left; height:30px; width:30px\" src=\"/ascension/Icons/FactionCreation/human.png\"><p style=\"color: #d7c297;>" + "<span style=\"font-size=20px;\">FORM UNIT</p>" +
...
function backtrackUnitOrigins(unitID, name, holder) {
    ...
    if (culture != "") {
        ...
        imag.setAttribute("src", "/ascension/Icons/Text/" + culture + ".png");
        imag.setAttribute('onerror', "this.setAttribute('src','/ascension/Icons/Text/mp.png')");
        imag.setAttribute("width", "60");
        imag.setAttribute("height", "60");
        btn.appendChild(imag);
        var wrap = btn.innerHTML;
        btn.innerHTML = "<a href=\"/ascension/HTML/" + capitalized + "Units.html\" target=\"_blank\">" + wrap + "</a>"
        //btn.appendChild(spa);
    ...
    if (tomes != "") {
        ...
        imag.setAttribute("src", "/ascension/Icons/TomeIcons/" + tomes.id + ".png");
        imag.setAttribute('onerror', "this.setAttribute('src','/ascension/Icons/Text/mp.png')");
        imag.setAttribute("width", "60");
        imag.setAttribute("height", "60");
        btn.appendChild(imag);
        var wrap = btn.innerHTML;
        btn.innerHTML = "<a href=\"/ascension/HTML/Spells.html?tome=" + tomes.id + "\" target=\"_blank\">" + wrap + "</a>"
        addTooltipListeners(btn, spa);
        holderOrigin.appendChild(btn);
        // add icon with mouseover
    ...
    for (x in spells) {
        ...
        imag.setAttribute("src", "/ascension/Icons/SpellIcons/" + spells[x].id + ".png");
        ...
        btn.appendChild(imag);
        var wrap = btn.innerHTML;
        btn.innerHTML = "<a href=\"/ascension/HTML/Spells.html?spell=" + spells[x].id + "\" target=\"_blank\">" + wrap + "</a>"
        //  btn.appendChild(spa);
    ...
    if (siege != "") {
        ...
        imag.setAttribute("src", "/ascension/Icons/SiegeIcons/" + siege.id + ".png");
        imag.setAttribute('onerror', "this.setAttribute('src','/ascension/Icons/Text/mp.png')");
        imag.setAttribute("width", "60");
        imag.setAttribute("height", "60");
        btn.appendChild(imag);
        var wrap = btn.innerHTML;
        btn.innerHTML = "<a href=\"/ascension/HTML/Spells.html?siege=" + siege.id + "\" target=\"_blank\">" + wrap + "</a>";
    ...
    if (struc != "") {
        ...
        imag.setAttribute("src", "/ascension/Icons/UpgradeIcons/" + struc.id + ".png");
        imag.setAttribute('onerror', "this.setAttribute('src','/ascension/Icons/Text/mp.png')");
        imag.setAttribute("width", "60");
        imag.setAttribute("height", "60");
        btn.appendChild(imag);
        var wrap = btn.innerHTML;
        btn.innerHTML = "<a href=\"/ascension/HTML/Spells.html?structure=" + struc.id + "\" target=\"_blank\">" + wrap + "</a>"
        addTooltipListeners(btn, spa);
        holderOrigin.appendChild(btn);
    ...
    if (wonder != "") {
        ...
        imag.setAttribute("src", "/ascension/Icons/StructurePics/" + wonder.id + ".png");
        imag.setAttribute('onerror', "this.setAttribute('src','/ascension/Icons/Text/mp.png')");
        imag.setAttribute("width", "60");
        imag.setAttribute("height", "60");
        btn.appendChild(imag);
        var wrap = btn.innerHTML;
        btn.innerHTML = "<a href=\"/ascension/HTML/Spells.html?wonder=" + wonder.id + "\" target=\"_blank\">" + wrap + "</a>"
        addTooltipListeners(btn, spa);
        holderOrigin.appendChild(btn);
        // add icon with mouseover
    ...
    if (tree != "") {
        ...
        imag.setAttribute("src", "/ascension/Icons/EmpireProgressionIcons/" + tree.id + ".png");
        imag.setAttribute('onerror', "this.setAttribute('src','/ascension/Icons/Text/mp.png')");
        imag.setAttribute("width", "60");
        imag.setAttribute("height", "60");
        btn.appendChild(imag);
        var wrap = btn.innerHTML;
        btn.innerHTML = "<a href=\"/ascension/HTML/EmpireTree.html \"target = \"_blank\">" + wrap + "</a>"
        addTooltipListeners(btn, spa);
    ...
    if (unitAbility != "") {
        ...
        imag.setAttribute("src", "/ascension/Icons/Abilities/" + unitAbility[1].slug + ".png");
        imag.setAttribute('onerror', "this.setAttribute('src','/ascension/Icons/Text/mp.png')");
        imag.setAttribute("width", "60");
        imag.setAttribute("height", "60");
        btn.appendChild(imag);
        var wrap = btn.innerHTML;
        btn.innerHTML = "<a href=\"/ascension/HTML/Units.html?unit=" + unitAbility[0].id + "\" target=\"_blank\">" + wrap + "</a>"
        addTooltipListeners(btn, spa);
        holderOrigin.appendChild(btn);
        // add icon with mouseover
    ...
    if (heroSkill != "") {
        ...
        if (heroSkill[0] != "") {
            imag.setAttribute("src", "/ascension/Icons/Abilities/" + heroSkill[0].icon + ".png");
        } else {
            imag.setAttribute("src", "/ascension/Icons/HeroSkillIcons/" + heroSkill[1].icon + ".png");
        }
        ...
        btn.appendChild(imag);
        var wrap = btn.innerHTML;
        btn.innerHTML = "<a href=\"/ascension/HTML/Spells.html?skill=" + heroSkill[1].id + "\" target=\"_blank\">" + wrap + "</a>"
        addTooltipListeners(btn, spa);
        holderOrigin.appendChild(btn);
        // add icon with mouseover
    ...
    if (evolve != "") {
        ...
        imag.setAttribute("src", "/ascension/Icons/Abilities/evolve.png");
        imag.setAttribute('onerror', "this.setAttribute('src','/ascension/Icons/Text/mp.png')");
        imag.setAttribute("width", "60");
        imag.setAttribute("height", "60");
        btn.appendChild(imag);
        var wrap = btn.innerHTML;
        btn.innerHTML = "<a href=\"/ascension/HTML/Units.html?unit=" + evolve.id + "\" target=\"_blank\">" + wrap + "</a>"
        // btn.appendChild(spa);
...
function addLevelUpInfo(units, a, holder) {
    ...
    if (evolveTarget != undefined) {
        ...
        levelText = "<bullet> Evolves into <hyperlink> <a href=\"/ascension/HTML/Units.html?unit=" + evolveTarget + "\" target=\"_blank\">" + lookupUnit(evolveTarget) + "</a></hyperlink></bullet>";
        levelup.append(NewLevelUpEntry(levelText));
    }
...
function showSiegeProject(id, showOrigin) {
    ...
    for (i in jsonSiegeProjects) {
        if (id === jsonSiegeProjects[i].name) {
            ...
            imagelink.setAttribute("src", "/ascension/Icons/SiegeIcons/" + jsonSiegeProjects[i].id + ".png");
...
function showEmpireUpgrade(skill, showOrigin) {
    ...
    imagelink.setAttribute("src", "/ascension/Icons/SpellIcons/" + imageLinkName + ".png");
...
function showTome(a, div) {
    ...
    for (j in jsonTomes) {
        if (a === jsonTomes[j].id) {
            ...
            imagelink.setAttribute("src", "/ascension/Icons/TomeIcons/" + a + ".png");
...
function createTooltipForEnchant(item) {
    ...
    image.setAttribute("src", "/ascension/Icons/SpellIcons/" + item.icon + ".png");
...
function SetEnchantment(evt) {
    ...
    if (!isInArray(evt.currentTarget.activeEnchantList, evt.currentTarget.enchant)) {
        ...
        image.setAttribute("src", "/ascension/Icons/SpellIcons/" + evt.currentTarget.enchant.icon + ".png");
...
function showStructure(a, showOrigin) {
    ...
    for (j in jsonStructureUpgrades) {
        if (a === jsonStructureUpgrades[j].id) {
            ...
            imagelink.setAttribute("src", "/ascension/Icons/UpgradeIcons/" + a + ".png");
            ...
            if (a.indexOf("wildlife_sanctuary") != -1) {
                ...
                var div = document.createElement("DIV");
                div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "goretusk_piglet" + "\" target=\"_blank\">" + GetUnitTierAndName("goretusk_piglet") + "</a>" + "</bullet>";
                unitTypesDiv.append(div);
                var div = document.createElement("DIV");
                div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "hunter_spider" + "\" target=\"_blank\">" + GetUnitTierAndName("hunter_spider") + "</a>" + "</bullet>";
                unitTypesDiv.append(div);
                var div = document.createElement("DIV");
                div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "razorback" + "\" target=\"_blank\">" + GetUnitTierAndName("razorback") + "</a>" + "</bullet>";
                unitTypesDiv.append(div);
                var div = document.createElement("DIV");
                div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "warg" + "\" target=\"_blank\">" + GetUnitTierAndName("warg") + "</a>" + "</bullet>";
                unitTypesDiv.append(div);
            }
            ...
            if (a.indexOf("demon_gate") != -1) {
                ...
                descriptionDiv.innerHTML += "<br>Unlocks Production of:";
                var div = document.createElement("DIV");
                div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "inferno_puppy" + "\" target=\"_blank\">" + GetUnitTierAndName("inferno_puppy") + "</a>" + "</bullet>";
                unitTypesDiv.append(div);
                var div = document.createElement("DIV");
                div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "gremlin" + "\" target=\"_blank\">" + GetUnitTierAndName("gremlin") + "</a>" + "</bullet>";
                unitTypesDiv.append(div);
                var div = document.createElement("DIV");
                div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "inferno_hound" + "\" target=\"_blank\">" + GetUnitTierAndName("inferno_hound") + "</a>" + "</bullet>";
                unitTypesDiv.append(div);
                var div = document.createElement("DIV");
                div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "chaos_eater" + "\" target=\"_blank\">" + GetUnitTierAndName("chaos_eater") + "</a>" + "</bullet>";
                unitTypesDiv.append(div);
            }
    ...
    for (j in jsonWorldStructures) {
        if (a === jsonWorldStructures[j].id) {
            ...
            if (jsonWorldStructures[j].type.indexOf("wonder") != -1) {
                ...
                imagelink.setAttribute("src", "/ascension/Icons/WorldStructures/" + a + ".png");
                imagelink.setAttribute("id", "modicon" + a);
            ...
            if ('unit_unlocks' in jsonWorldStructures[j]) {
                ...
                for (x in jsonWorldStructures[j].unit_unlocks) {
                    ...
                    div.innerHTML = "<a href=\"/ascension/HTML/Units.html?unit=" + jsonWorldStructures[j].unit_unlocks[x].slug + "\" target=\"_blank\">" + GetUnitTierAndName(jsonWorldStructures[j].unit_unlocks[x].slug) + "</a>" + "</bullet>";
                    unitTypesDiv.appendChild(div);
                }
            }
            unitTypesDiv.setAttribute("id", "affectUnitTypes" + a);
            ...
            preview.setAttribute("src", "/ascension/Icons/StructurePics/" + a + ".png");
...
function FindCombatEnchantment(id) {
    ...
    for (i in jsonCombatEnchantments) {
        if (jsonCombatEnchantments[i].origin_structure === id) {
            ...
            var div = document.createElement("DIV");
            div.innerHTML = "<img style=\"float:left; height:80px; padding:10px\" src=\"/ascension/Icons/CombatEnchantments/" + jsonCombatEnchantments[i].id + ".png\"><p style=\"color: #aa84f6;>" + "<span style=\"font-size=20px;\">" + jsonCombatEnchantments[i].name.toUpperCase() + "</p>" +
...
function ShowDestinyTraits() {
    ...
    for (j in jsonDestiny.traits) {
        ...
        imagelink.setAttribute("src", "/ascension/Icons/EmpireProgressionIcons/" + a + ".png");
        imagelink.setAttribute("id", "modicon" + a);
        imagelink.setAttribute("style", "background-image: none");
        descriptionDiv.innerHTML = description;
        descriptionDiv.setAttribute("id", "modicon" + a);
...
function showUnitUnlock(a) {
    ...
    if (a.name === "Young Dragon") {
        ...
        for (i in alldragons) {
            var div = document.createElement("DIV");
            div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + alldragons[i] + "\" target=\"_blank\">" + GetUnitTierAndName(alldragons[i]) + "</a>" + "</bullet>";
            unitTypesDiv.appendChild(div);
        }
        ...
        var div = document.createElement("DIV");
        div.innerHTML = "<a href =\"/ascension/HTML/Units.html?unit=" + a.unit_slug + "\" target=\"_blank\">" + GetUnitTierAndName(a.unit_slug) + "</a>" + "</bullet>";
        unitTypesDiv.appendChild(div);
    ...
    imagelink.setAttribute("src", "/ascension/Icons/SpellIcons/" + a.unit_slug + ".png");
    imagelink.setAttribute("id", "modicon" + a);
    descriptionDiv.innerHTML = description;
    descriptionDiv.setAttribute("id", "modicon" + a);
        ...
        if (a === jsonSpells[j].id) {
            ...
            if ('summoned_units' in jsonSpells[j]) {
                ...
                for (x in jsonSpells[j].summoned_units) {
                    var div = document.createElement("DIV");
                    div.setAttribute("style", "margin-right: 20px;");
                    div.innerHTML = "<a href=\"/ascension/HTML/Units.html?unit=" + jsonSpells[j].summoned_units[x].slug + "\" target=\"_blank\">" + GetUnitTierAndName(jsonSpells[j].summoned_units[x].slug) + "</a>";
                    unitTypesDiv.appendChild(div);
                }
            }
...
function showItem(a) {
    ...
    var tomeOriginIcon = document.getElementById("originTomeIcon");
    tomeOriginIcon.setAttribute("src", "/ascension/Icons/Abilities/" + a.icon + ".png");
...
function showTraitSetup(currentTrait) {
    ...
    if ('DLC' in currentTrait) {
        ...
        if (currentTrait.DLC == "EMPIRESANDASHES ") {
            imag.setAttribute("src", "/ascension/Icons/Text/EmpiresAshes.png");
            spa.innerHTML = "Part of the Empires & Ashes DLC";

        } else if (currentTrait.DLC == "DRAGONLORDS ") {
            imag.setAttribute("src", "/ascension/Icons/Text/DragonDawn.png");
            spa.innerHTML = "Part of the Dragon Dawn DLC";
        } else if (currentTrait.DLC == "PRIMALFURY ") {
            imag.setAttribute("src", "/ascension/Icons/Text/PrimalFury.png");
    ...
    imagelink.setAttribute("src", "/ascension/Icons/FactionCreation/" + iconLink + ".png");
    imagelink.setAttribute("style", "background-image:none");
        ...
        if (jsonHeroTraits[i].id === a) {
            ...
            if ('units' in jsonHeroTraits[i]) {
                ...
                for (l in jsonHeroTraits[i].units) {
                    ...
                    var div = document.createElement("DIV");
                    div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + jsonHeroTraits[i].units[l].slug + "\" target=\"_blank\">" + GetUnitTierAndName(jsonHeroTraits[i].units[l].slug) + "</a>" + "</bullet>";
                    unitTypesDiv.append(div);
                }
            }
            unitTypesDiv.setAttribute("id", "affectUnitTypes" + a);
            ...
            imagelink = document.getElementById("modicon");
            imagelink.setAttribute("src", "/ascension/Icons/Abilities/" + heroTraitImage.toLowerCase() + ".png");
            imagelink.setAttribute("style", "background-image:none");
            imagelink.setAttribute("id", "modicon" + a);
...
function showSkill(a, checkInAbilities, icon_slug, category, level, group_name) {
    ...
    if (a.id === "summon_elemental") {
        ...
        var div = document.createElement("DIV");
        div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "tide_spirit" + "\" target=\"_blank\">" + GetUnitTierAndName("tide_spirit") + "</a>" + "</bullet>";
        unitTypesDiv.append(div);
        var div = document.createElement("DIV");
        div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "storm_spirit" + "\" target=\"_blank\">" + GetUnitTierAndName("storm_spirit") + "</a>" + "</bullet>";
        unitTypesDiv.append(div);
        var div = document.createElement("DIV");
        div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "magma_spirit" + "\" target=\"_blank\">" + GetUnitTierAndName("magma_spirit") + "</a>" + "</bullet>";
        unitTypesDiv.append(div);
        var div = document.createElement("DIV");
        div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "snow_spirit" + "\" target=\"_blank\">" + GetUnitTierAndName("snow_spirit") + "</a>" + "</bullet>";
        unitTypesDiv.append(div);
        var div = document.createElement("DIV");
        div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "stone_spirit" + "\" target=\"_blank\">" + GetUnitTierAndName("stone_spirit") + "</a>" + "</bullet>";
        unitTypesDiv.append(div);
    }
    ...
    if (a.id === "summon_animal") {
        ...
        descriptionDiv.innerHTML += "<br>Summoned Units:";
        var div = document.createElement("DIV");
        div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "unicorn" + "\" target=\"_blank\">" + GetUnitTierAndName("unicorn") + "</a>" + "</bullet>";
        unitTypesDiv.append(div);
        var div = document.createElement("DIV");
        div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "nightmare" + "\" target=\"_blank\">" + GetUnitTierAndName("nightmare") + "</a>" + "</bullet>";
        unitTypesDiv.append(div);
        var div = document.createElement("DIV");
        div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "thunderbird" + "\" target=\"_blank\">" + GetUnitTierAndName("thunderbird") + "</a>" + "</bullet>";
        unitTypesDiv.append(div);
        var div = document.createElement("DIV");
        div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "goretusk_matriarch" + "\" target=\"_blank\">" + GetUnitTierAndName("goretusk_matriarch") + "</a>" + "</bullet>";
        unitTypesDiv.append(div);
        var div = document.createElement("DIV");
        div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "caustic_worm" + "\" target=\"_blank\">" + GetUnitTierAndName("caustic_worm") + "</a>" + "</bullet>";
        unitTypesDiv.append(div);
    }
    ...
    if (a.id === "summon_undead") {
        ...
        var div = document.createElement("DIV");
        div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "corrupt_soul" + "\" target=\"_blank\">" + GetUnitTierAndName("corrupt_soul") + "</a>" + "</bullet>";
        unitTypesDiv.append(div);

        var div = document.createElement("DIV");
        div.innerHTML = "<bullet>" + "<a href=\"/ascension/HTML/Units.html?unit=" + "banshee" + "\" target=\"_blank\">" + GetUnitTierAndName("banshee") + "</a>" + "</bullet>";
        unitTypesDiv.append(div);
    }
    ...
    if (a.type === "signature") {
        ...
        imagelink.setAttribute("src", "/ascension/Icons/Abilities/" + icon_slug + ".png");
            ...
            if ('hero_skills' in jsonTomes[j]) {
                for (k in jsonTomes[j].hero_skills) {
                    if (jsonTomes[j].hero_skills[k].slug === id) {
                        ...
                        var tomeOriginIcon = document.getElementById("originTomeIcon");
                        tomeOriginIcon.setAttribute("src", "/ascension/Icons/TomeIcons/" + jsonTomes[j].id + ".png");
                        var wrap = tomeOrigin.innerHTML;
                        tomeOrigin.innerHTML = "<a href=\"/ascension/HTML/Spells.html?tome=" + jsonTomes[j].id + "\" target=\"_blank\">" + wrap + "</a>"
...
function backtraceTomeOriginAndTier(spell, showorigin) {
    if (spell === "create_bone_golem" && showorigin) {
        ...
        var tomeOriginIcon = document.getElementById("originTomeIcon");
        tomeOriginIcon.setAttribute("src", "/ascension/Icons/TomeIcons/tome_of_souls.png");
        var wrap = tomeOrigin.innerHTML;
        tomeOrigin.innerHTML = "<a href=\"/ascension/HTML/Spells.html?tome=tome_of_souls\" target=\"_blank\">" + wrap + "</a>"
    } else {
        for (j in jsonTomes) {
            {
                for (k in jsonTomes[j].skills) {
